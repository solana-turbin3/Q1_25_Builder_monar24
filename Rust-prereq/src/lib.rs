...
mod tests {
    ...
    const RPC_URL: &str = "https://rpc.ankr.com/solana_devnet";
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("5jKWBYpD8LdtaABipnHskmpHWbnX5oCRgsUvAR9SoSK3").unwrap();
